...
* 📂 `/reports/Diseño e implementación de una base de datos relacional.pdf`: Documentación técnica que incluye el análisis del problema, diagrama relacional detallado y evidencia de la ejecución del código SQL.
